...
<html lang="en">
    <head>
        ...
        <link href="<?php echo $view->getThemePath() ?>/js/colorbox/colorbox.css"  rel='stylesheet' type='text/css'>
        <link href="<?php echo $view->getThemePath() ?>/css/templatemo_style.css"  rel='stylesheet' type='text/css'>
    ...
    <body>
            ...
            <div class="container">
                <div class="subheader">
                    <div id="phone" class="pull-left">
                            <img src="<?php echo $view->getThemePath() ?>/images/phone.png" alt="phone"/>
                            010-020-0340
                    </div>
                    <div id="email" class="pull-right">
                            <img src="<?php echo $view->getThemePath() ?>/images/email.png" alt="email"/>
                            contact@website.com
                    </div>
                </div>
            </div>
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a rel="nofollow" href="http://www.templatemo.com/preview/templatemo_395_urbanic" class="navbar-brand"><img src="<?php echo $view->getThemePath() ?>/images/templatemo_logo.png" alt="logo"/></a>
                        </div>
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                ...
                                <li><a rel="nofollow" href="http://www.templatemo.com" class="external-link">EXTERNAL</a></li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="templatemo-service-item">
                            <div>
                                <img src="<?php echo $view->getThemePath() ?>/images/leaf.png" alt="icon" />
                    ...
                    <div class="col-md-4">
                        <div class="templatemo-service-item">
                            <div>
                                <img src="<?php echo $view->getThemePath() ?>/images/battery.png" alt="icon"/>
                ...
                <div class="clearfix"> </div>
                    <ul class="row row_team">
                        <li class="col-lg-3 col-md-3 col-sm-6 ">
                            <div class="text-center">
                                <div class="member-thumb">
                                    <img src="<?php echo $view->getThemePath() ?>/images/member1.jpg" class="img-responsive" alt="member 1" />
                        ...
                        <li class="col-lg-3 col-md-3 col-sm-6 ">
                            <div class="text-center">
                                <div class="member-thumb">
                                    <img src="<?php echo $view->getThemePath() ?>/images/member2.jpg" class="img-responsive" alt="member 2" />
                                    <div class="thumb-overlay">
                        ...
                        <li class="col-lg-3 col-md-3 col-sm-6 ">
                            <div class="text-center">
                                <div class="member-thumb">
                                    <img src="<?php echo $view->getThemePath() ?>/images/member3.jpg" class="img-responsive" alt="member 3" />
                                    <div class="thumb-overlay">
                                        <a href="#"><span class="social-icon-fb"></span></a>
                                        <a href="#"><span class="social-icon-twitter"></span></a>
                                        <a href="#"><span class="social-icon-linkedin"></span></a>
                        ...
                        <li class="col-lg-3 col-md-3 col-sm-6 ">
                            <div class="text-center">
                                <div class="member-thumb">
                                    <img src="<?php echo $view->getThemePath() ?>/images/member4.jpg" class="img-responsive" alt="member 4" />
                                    <div class="thumb-overlay">
                                        <a href="https://www.facebook.com/templatemo" rel="nofollow"><span class="social-icon-fb"></span></a>
                                        <a href="#"><span class="social-icon-twitter"></span></a>
                                        <a href="#"><span class="social-icon-linkedin"></span></a>
                ...
                <div class="text-center">
                    <ul class="templatemo-project-gallery" >
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-graphic" >
                            <a class="colorbox" href="images/full-gallery-image-1.jpg" data-group="gallery-graphic">
                                <div class="templatemo-project-box">
                                    ...
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-1.jpg" class="img-responsive" alt="gallery" />
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-creative" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-2.jpg" data-group="gallery-creative">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-2.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Creative</h5>
                                        <hr />
                                        <h4>BREAKFAST</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-inspiration" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-3.jpg" data-group="gallery-inspiration">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-3.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Inspiration</h5>
                                        <hr />
                                        <h4>GREEN COLORS</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-design" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-4.jpg" data-group="gallery-design">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-4.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Web Design</h5>
                                        <hr />
                                        <h4>CAMERA</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-inspiration" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-5.jpg" data-group="gallery-inspiration">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-5.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Inspiration</h5>
                                        <hr />
                                        <h4>PLANT</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2  gallery gallery-inspiration" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-6.jpg" data-group="gallery-inspiration">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-6.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Inspiration</h5>
                                        <hr />
                                        <h4>CABLE TRAIN</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-design" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-7.jpg" data-group="gallery-design">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-7.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Web Design</h5>
                                        <hr />
                                        <h4>CITY</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-creative" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-8.jpg" data-group="gallery-creative">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-8.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Creative</h5>
                                        <hr />
                                        <h4>BIRDS</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-graphic" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-9.jpg" data-group="gallery-graphic">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-9.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Graphic</h5>
                                        <hr />
                                        <h4>NATURE</h4>
                        ...
                        <li class="col-lg-2 col-md-2 col-sm-2 gallery gallery-inspiration" >
                            <a class="colorbox" href="<?php echo $view->getThemePath() ?>/images/full-gallery-image-10.jpg" data-group="gallery-inspiration">
                                <div class="templatemo-project-box">
                                    <img src="<?php echo $view->getThemePath() ?>/images/gallery-image-10.jpg" class="img-responsive" alt="gallery" />
                                    <div class="project-overlay">
                                        <h5>Inspiration</h5>
                                        <hr />
                                        <h4>DOGGY</h4>
                ...
                <div class="blog_box">
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            <li class="col-md-4">
                                <a href="#">
                                    <img class="img-responsive" src="<?php echo $view->getThemePath() ?>/images/blog-image-1.jpg" alt="gallery 1" />
                                </a>
                            </li>
                            <li  class="col-md-8">
                                <div class="pull-left">
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            <li class="col-md-4"><a href="#">
                                <img class="img-responsive" src="<?php echo $view->getThemePath() ?>/images/blog-image-2.jpg" alt="gallery 2" /></a>
                            </li>
                            <li class="col-md-8">
                                <div class="pull-left">
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            <li class="col-md-4"><a href="#">
                                <img class="img-responsive" src="<?php echo $view->getThemePath() ?>/images/blog-image-2.jpg" alt="gallery 3" /></a>
                            </li>
                            <li class="col-md-8">
                                <div class="pull-left">
                    ...
                    <div class="col-sm-5 col-md-6 blog_post">
                        <ul class="list-inline">
                            <li class="col-md-4">
                                <a href="#">
                                    <img class="img-responsive" src="<?php echo $view->getThemePath() ?>/images/blog-image-1.jpg"  alt="gallery 4" />
                                </a>
                            </li>
                            <li class="col-md-8">
                                <div class="pull-left">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 contact_right">
                        ...
                        <p><img src="<?php echo $view->getThemePath() ?>/images/location.png" alt="icon 1" /> 123 Dagon Studio, Yakin Street, Digital Estate</p>
                        <p><img src="<?php echo $view->getThemePath() ?>/images/phone1.png"  alt="icon 2" /> 010-020-0340</p>
                        <p><img src="<?php echo $view->getThemePath() ?>/images/globe.png" alt="icon 3" /><a class="link_orange" href="#"><span class="txt_orange">www.company.com</span></a></p>
        ...
        <div class="templatemo-tweets">
            <div class="container">
                <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-1">
                                <img src="<?php echo $view->getThemePath() ?>/images/quote.png" alt="icon" />
                        </div>
                        ...
                        <div style="margin-top:60px;">
                            <ul class="list-inline">
                                <li class="col-sm-2 col-md-2 templatemo-partner-item">
                                    <a href="#"><img src="<?php echo $view->getThemePath() ?>/images/partner1.jpg" class="img-responsive" alt="partner 1" /></a>
                                </li>
                                <li class="col-sm-2 col-md-2 templatemo-partner-item">
                                    <a href="#"><img src="<?php echo $view->getThemePath() ?>/images/partner2.jpg" class="img-responsive" alt="partner 2" /></a>
                                </li>
                                <li class="col-sm-2 col-md-2 templatemo-partner-item">
                                    <a href="#"><img src="<?php echo $view->getThemePath() ?>/images/partner3.jpg" class="img-responsive" alt="partner 3" /></a>
                                </li>
                                <li class="col-sm-2 col-md-2 templatemo-partner-item">
                                    <a href="#"><img src="<?php echo $view->getThemePath() ?>/images/partner4.jpg" class="img-responsive" alt="partner 4" /></a>
                                </li>
                                <li class="col-sm-2 col-md-2 templatemo-partner-item">
                                    <a href="#"><img src="<?php echo $view->getThemePath() ?>/images/partner5.jpg" class="img-responsive" alt="partner 5" /></a>
                                </li>
                                <li class="col-sm-2 col-md-2 templatemo-partner-item">
                                    <a href="#"><img src="<?php echo $view->getThemePath() ?>/images/partner6.jpg" class="img-responsive" alt="partner 6" /></a>
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="footer_bottom_content">Copyright © 2084 <a href="#">Your Company Name</a> - <a rel="nofollow" href="http://www.templatemo.com/preview/templatemo_395_urbanic" class="link_orange"><span class="txt_orange">Urbanic</span></a> by <a rel="nofollow" href="http://www.templatemo.com">Free Templates</a></div>
        ...
        <script src="<?php echo $view->getThemePath() ?>/js/jquery.min.js" type="text/javascript"></script>
        <script src="<?php echo $view->getThemePath() ?>/js/bootstrap.min.js"  type="text/javascript"></script>
        <script src="<?php echo $view->getThemePath() ?>/js/stickUp.min.js"  type="text/javascript"></script>
        <script src="<?php echo $view->getThemePath() ?>/js/colorbox/jquery.colorbox-min.js"  type="text/javascript"></script>
        <script src="<?php echo $view->getThemePath() ?>/js/templatemo_script.js"  type="text/javascript"></script>
     </div>
